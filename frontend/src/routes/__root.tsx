  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Something went wrong. You can try again.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KCIP — Karnataka Crime Intelligence Platform" },
      { name: "description", content: "AI-driven crime analytics and visualization dashboard for the Karnataka State Police." },
      { property: "og:title", content: "KCIP — Karnataka Crime Intelligence Platform" },
      { property: "og:description", content: "AI-driven crime analytics and visualization dashboard for the Karnataka State Police." },
