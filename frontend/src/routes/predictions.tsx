...
import { usePredictions } from "@/hooks/api/useKcipQueries";
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Card className="p-5">
          ...
          <div className="mt-3 text-4xl font-bold">{predictions?.riskScore ?? 0}</div>
          <Progress value={predictions?.riskScore ?? 0} className="mt-3" />
        </Card>
        <Card className="p-5">
          ...
          <div className="mt-3 text-4xl font-bold">{predictions?.confidence ?? 0}%</div>
          <Progress value={predictions?.confidence ?? 0} className="mt-3" />
        </Card>
        <Card className="p-5">
