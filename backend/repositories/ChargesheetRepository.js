 ...
 * @description Chargesheet Data Access Repository — Catalyst Data Store implementation
...
import { CatalystChargesheetRepository } from './catalyst/CatalystChargesheetRepository.js';
...
export class ChargesheetRepository extends BaseRepository {
  ...
  constructor(catalystApp = null) {
    super();
    this.store = new CatalystChargesheetRepository(catalystApp);
  }
  ...
  async findByChargesheetNumber(csNumber) {
    return this.store.findByChargesheetNumber(csNumber);
  }
}
