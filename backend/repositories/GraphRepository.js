 ...
 * @description Crime Network Graph Repository — Catalyst Data Store implementation
...
import { CatalystGraphRepository } from './catalyst/CatalystGraphRepository.js';
...
export class GraphRepository extends BaseRepository {
  ...
  constructor(catalystApp = null) {
    super();
    this.store = new CatalystGraphRepository(catalystApp);
  }
  ...
  async getNetworkByRootId(rootId, depth = 2) {
    return this.store.getNetworkByRootId(rootId, depth);
  }
}
